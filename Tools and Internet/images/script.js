...
let sum = 0 , total, input = 0, input1=0;
let updateArray=new Array() , f = 0;
...
button.addEventListener('click',function(){
  ...
  number.value = out;
     ...
     price1.innerText=`$`+10.50;
     let output = output1 * 10.50 ;
     console.log(output);
...
button1.addEventListener('click',function(){
  ...
  price1.innerText=`$`+14.50;
  let output = output1 * 14.50 ;
...
price1.innerText=`$`+18.50;
  let output =  output1 * 18.50 ;
...
price1.innerText=`$`+28.50;
  let output = output1 * 28.50 ;
  balance(output);
...
price1.innerText=`$`+12.50;
  let output = output1 * 12.50 ;
  balance(output);
